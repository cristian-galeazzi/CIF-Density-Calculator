...
Regenerates five synthetic test files from published lattice parameters
and runs the whole pipeline on them. Two independent tolerance levels:
...
IUPAC_MASS = {"Na": 22.98976928, "Cl": 35.45, "Si": 28.085, "Ce": 140.116, "O": 15.999}

NACL_A, SI_A, CEO2_A = 5.6402, 5.43095, 5.4113
...
def batch(tmp_path_factory):
    """Write the five synthetic test files and process them once."""
